class ErrorMessage:
    ...
    HTML_FILE = "cant open content file"
    HTML_DB = "cant get content file from mail template"
    EMAIL_ERROR = "email did not sent"
    LISTENING_FAIL = "consumer listening fail"
    ...
    ADDRESS_FORMAT = "Invalid email address"
